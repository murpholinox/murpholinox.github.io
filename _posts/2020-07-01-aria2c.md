...
By the way, that line is supposed to make `aria2c`  to seed for only one minute, not a nice thing to do, after download is complete and exit `aria2c` automatically. 
